...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM Payment WHERE ReceiptID = $id";
...
<form action="Payment_update.php" method="POST">
    <div style="background-color: rgba(0, 0, 0, 0.8); width: 28%; margin-left:700px; border-style: none;">
        <p style="font-size: 32px; color: white; margin-left:50px; padding:20px;"><b>Update Payment Details</b></p>

        <input type="hidden" name="ReceiptID" value="<?php echo $id; ?>">

        <input type="text" placeholder="Name" name="name" value="<?php echo $name; ?>" required style="height:39px; margin-left: 90px; background-color: rgba(50, 50, 50, 0.4); width: 300px;padding-left: 30px;color: #989898;border-radius: 4px; font-size: 17px; border: 1px solid;"><br><br>

        <input type="text" name="cardnumber" maxlength="16" pattern="\d{16}" placeholder="Card Number (16 digits)" value="<?php echo $acc; ?>" required style="height:39px; margin-left: 90px; background-color: rgba(50, 50, 50, 0.4); width: 300px;padding-left: 30px;color: #989898;border-radius: 4px; font-size: 17px; border: 1px solid;"><br><br>

        <input type="date" name="expiry_date" value="<?php echo $date; ?>" required style="height:39px; margin-left: 90px; background-color: rgba(50, 50, 50, 0.4); width: 300px; padding-left: 30px;color: #989898;border-radius: 4px;font-size: 17px; border: 1px solid;"><br><br>

        <input type="text" name="cvc" maxlength="3" pattern="\d{3}" placeholder="CVC" value="<?php echo $cvc; ?>" required style="height:39px; margin-left: 90px; background-color: rgba(50, 50, 50, 0.4); width: 300px; padding-left: 30px;color: #989898;border-radius: 4px;font-size: 17px; border: 1px solid;"><br><br>

        <select name="plan" required style="height:39px; margin-left: 90px; background-color: rgba(50, 50, 50, 0.4); width: 335px; padding-left: 20px;color: #989898; border-radius: 4px; font-size: 17px; border: 1px solid;">
            <option disabled>Choose Subscription Plan</option>
            <option <?php if ($plan == 'Premium - Rs-1100/month') echo 'selected'; ?>>Premium - Rs-1100/month</option>
            <option <?php if ($plan == 'Standard - Rs-750/month') echo 'selected'; ?>>Standard - Rs-750/month</option>
            <option <?php if ($plan == 'Basic - Rs-250/month') echo 'selected'; ?>>Basic - Rs-250/month</option>
        </select><br><br>
